<template>
  ...
  >
    ...
    <div class="relative z-20 flex flex-col items-center gap-7 px-0">
      <h1
        class="text-secondary drop-shadow text-center text-3xl md:text-5xl font-extrabold uppercase tracking-wide shadow-primary/40 leading-tight"
      >
        Guidando il futuro del<br />
        <span class="bg-primary/30 text-foreground px-2 py-1 rounded-xl"
          >building italiano</span
        >
      </h1>
      <p
        class="text-lg md:text-2xl text-foreground text-center max-w-2xl font-semibold drop-shadow-lg bg-black/20 rounded-xl px-4 py-2"
      >
        Sono leledan06, costruttore Minecraft che trasforma idee in mondi unici.
        Creo ambientazioni naturali e strutture creative, condividendo il mio
        lavoro e ispirando altri a scoprire le possibilità di Minecraft.
      </p>
      <NuxtLink
        to="/about"
